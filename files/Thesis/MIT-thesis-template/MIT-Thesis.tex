...
\usepackage{gb4e}
\noautomath % prevents clash with other packages from the template
...
\newcommand{\parencitetoappear}[1]{(\citeauthor{#1}, to appear)}
\newcommand{\textcitetoappear}[1]{\citeauthor{#1} (to appear)}


\addbibresource{biblio.bib}%% <== change to YOUR bib file <= CHANGE
...
\Author{Adèle Hénot-Mortier}{Department of Linguistics and Philosophy}
...
\Degree{Doctor of Philosophy in Linguistics}{Department of Linguistics and Philosophy}

% If there is more than one supervisor, use the \Supervisor command for each.
\Supervisor{Athulya Aravind}{Associate Professor of Linguistics and Cognitive Science}
% \Supervisor{Edward C. Pickering}{Professor of Physics, and \\ \> Professor of Something Else}
\Supervisor{Amir Anvari}{Assistant Professor of Linguistics}
% \Supervisor{Quintus Castor}{Professor of Log Dams}

% Professor who formally accepts theses for your department (e.g., the Graduate Officer, Professor Sméagol,...)
% If more than one department, use more than once
\Acceptor{Danny Fox}{Anshen-Chomsky Professor of Language \& Thought}{Linguistics Section Head} % \\ \> Third title}
...
\begin{flushright}
	\textit{Hier, on se regardait à peine}\\
	\textit{C'est à peine si l'on se penchait}\\
	\textit{Aujourd'hui, nos regards sont suspendus}\\
	\textit{Résidents, résidents de la République}\\
	\textit{Où le rose a des reflets bleus}\\\vspace{3mm}
	Alain Bashung/Gaëtan Roussel
\end{flushright}
...
%\include{chapters/chap1}% .tex extension is presumed 	intro Margol
%\include{chapters/chap2}% .tex extension is presumed	qtrees Trym
%\include{chapters/chap4}% .tex extension is presumed	redundancy Kat onoma
%\include{chapters/chap5}% .tex extension is presumed	HDs JJBA
%\include{chapters/chap6}% .tex extension is presumed	HCs poni hoax
\include{chapters/chap7}% .tex extension is presumed	economy Sexy Sushi
