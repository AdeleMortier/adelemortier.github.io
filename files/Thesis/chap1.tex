...
\begin{figure}[H]
	...
	\begin{subfigure}[t]{.27\linewidth}
		...
		\end{tikzpicture}
		\caption{Interecting the proposition that \textit{It's raining} (\begin{tikzpicture}
...
\begin{exe}
	\ex {\textsc{\textbf{Question-Answer Congruence}} \citep{Katzir2015}. A felicitous assertion has to be a good answer to a good question.}\label{ex1:q-a-congruence}
\end{exe}
